...
d = 0.1  # mic distance
d = 0.04  # mic distance
#distances = np.array([0, 0.14, 0.12, 0.1, 0.08, 0.06, 0.04, 0.06, 0.08, 0.1, 0.12, 0.14, 0.16, 0.18, 0.2, 0.22, 0.24, 0.26])
distances = np.array([0, 0.14, 0.26, 0.36, 0.44, 0.5, 0.54, 0.6, 0.68, 0.78, 0.90, 1.04, 1.2, 1.38, 1.58, 1.8, 2.04, 2.3])
