...
for time_idx in range(0, int(RATE / CHUNK * RECORD_SECONDS)):
    ...
    # Modificación para evitar la sincronización y detección de picos después de que ambos estén sincronizados
    if not (synced_12 and synced_13):
        # Sincronización y detección de picos solo si no están sincronizados aún

        # Detección de picos y sincronización
        ...
        # Continuar con el proceso solo si hay picos detectados
        if peaks_1.size > 0 and peaks_2.size > 0 and peaks_4.size > 0:
            ...
            signal_1_ch5 = buffers[0][start_idx:end_idx, 3]  # canal 4 dispositivo 1
            signal_2_ch1 = buffers[1][start_idx:end_idx, 0]  # canal 1 dispositivo 2
            signal_3_ch1 = buffers[2][start_idx:end_idx, 3]  # canal 4 dispositivo 3
        ...
        if peaks_1.size > 0 and peaks_2.size > 0 and not synced_12:
            ...
            if abs(time_difference_12) > TARGET_DIFFERENCE:
                ...
                synced_12 = True  # Sincronización exitosa entre 1 y 2
                print("Synchronized 1 and 2")

            else:
                print(f"Time difference detected between devices 1 and 2: {time_difference_12:.6f} seconds "
                      f"(less than TARGET_DIFFERENCE, no further adjustment)")
        ...
        if peaks_1.size > 0 and peaks_4.size > 0 and not synced_13:
            ...
            if abs(time_difference_13) > TARGET_DIFFERENCE:
                ...
                synced_13 = True  # Sincronización exitosa entre 1 y 3
        ...
        # Si ya están sincronizados, omitir esta parte del código
        print("Devices 1, 2, and 3 are already synchronized. Skipping peak detection and synchronization.")
