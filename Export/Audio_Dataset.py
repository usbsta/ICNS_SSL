...
beamformed_signal_up_list = []
beamformed_signal_down_list = []
beamformed_signal_right_list = []
beamformed_signal_left_list = []
beamformed_signal_random_lists = [[] for _ in range(50)]  # Para 50 posiciones aleatorias
...
# Variables para sincronización obtenidas de Sim_Rec_24ch.py
...
try:
    for time_idx, i in zip(range(0, int(RATE / CHUNK * RECORD_SECONDS)), range(len(flight_data))):
        ...
        # Añadir el chunk beamformed a la lista
        ...
        if new_elevation_up <= elevation_range[-1]:
            ...
            beamformed_signal_up_list.append(beamformed_signal_chunk_up)
        ...
        if new_elevation_down >= elevation_range[0]:
            ...
            beamformed_signal_down_list.append(beamformed_signal_chunk_down)
        ...
        beamformed_signal_right_list.append(beamformed_signal_chunk_right)
        ...
        beamformed_signal_left_list.append(beamformed_signal_chunk_left)
        ...
        for idx_random in range(50):
            ...
            beamformed_signal_random_lists[idx_random].append(beamformed_signal_chunk_rand)
    ...
    def save_beamformed_signal(beamformed_signal_list, filename):
        if beamformed_signal_list:
    ...
    save_beamformed_signal(beamformed_signal_list, 'beamformed_signal_actual.wav')
    save_beamformed_signal(beamformed_signal_up_list, 'beamformed_signal_10deg_up.wav')
    save_beamformed_signal(beamformed_signal_down_list, 'beamformed_signal_10deg_down.wav')
    save_beamformed_signal(beamformed_signal_right_list, 'beamformed_signal_10deg_right.wav')
    save_beamformed_signal(beamformed_signal_left_list, 'beamformed_signal_10deg_left.wav')

    # Guardar las señales de las posiciones aleatorias
    for idx_random in range(50):
        beamformed_signal_random = np.concatenate(beamformed_signal_random_lists[idx_random])
        # Normalizar la señal beamformed
